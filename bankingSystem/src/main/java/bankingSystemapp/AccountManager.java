...
public class AccountManager {
    ...
    public void deleteAccount(long accountNumber) throws SQLException {
        ...
        System.out.print("Enter Security Pin to confirm account deletion: ");
        ...
        try {
            ...
            if (rowsAffected > 0) {
                ...
                System.out.println("Failed to delete account. Please check your account number and security pin.");
                connection.rollback();
            }
        } catch (SQLException e) {
            connection.rollback();
    ...
    public void viewAllAccountDetails() {
        try {
            ...
            while (resultSet.next()) {
                ...
                System.out.println(); // Add spacing between accounts
            }
        } catch (SQLException e) {
